<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"F:\wamp64\www\TP5.0_35\TP5.0\public/../application/admin\view\blogc\addblog.html";i:1502709124;}*/ ?>
﻿<!DOCTYPE html>
<!--
                        ...
                        <div class="col-lg-10 col-sm-10 col-xs-10">
                            <div class="widget">
                                ...
                                <div class="widget-body">
                                    <div>
                                        <form role="form" method="post" enctype="multipart/form-data" class="form" action="<?php echo url('admin/addblog/add'); ?>">
