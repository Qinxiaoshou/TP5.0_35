<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"F:\wamp64\www\TP5.0_35\TP5.0\public/../application/admin\view\blogc\login.html";i:1502701128;}*/ ?>
﻿<!doctype html>
<html lang="en">
    ...
    <div class="login-container animated fadeInDown">
        <div class="loginbox bg-white">
            <div class="loginbox-social">
                <div class="timg">
                     <img src="/static/img/avatars/luo.jpg" alt="divyia avatar" />
                </div>
            </div>
            <div class="loginbox-or">
             ...
             <form role="form" method="post"  class="form" action="<?php echo url('admin/login/logincheck'); ?>">
