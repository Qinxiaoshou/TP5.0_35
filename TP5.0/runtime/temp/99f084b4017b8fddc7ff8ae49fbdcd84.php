<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"F:\wamp64\www\TP5.0_35\TP5.0\public/../application/admin\view\blogc\updatepage.html";i:1502507455;}*/ ?>
﻿<!DOCTYPE html>
<!--
    ...
    <div class="page-container">
        ...
        <div class="page-sidebar" id="sidebar">
            ...
            <ul>
                ...
                <!--Widgets-->
                <li class="nav sidebar-menu">
                    <a href="manageblog.html">
                ...
                <li>
                    <a href="#" >
                        ...
                        <span class="menu-text"> 管理个人信息 </span>
                    </a>
                </li>
                            ...
                            <div class="widget">
                                ...
                                <div class="widget-body">
                                    <div>
                                        ...
                                        <form  method="post" enctype="multipart/form-data" class="form" action="<?php echo url('admin/blogc/updateblog',array('tid' =>$blog['tid'])); ?>">
                                            <div class="form-group">
                                                <label for="blogimg">博客图片:<?php echo $blog['blogimg']; ?></label>
                                                <input type="hidden" name="blogimg" value="<?php echo $blog['blogimg']; ?>">
                                                <div class="databox databox-graded">
                                                    ...
                                                    <div class="databox-right padding-top-20 bg-whitesmoke">
                                                        <input type="file" class="btn" id="newblogimg" name="newblogimg">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="title" name="title" placeholder="<?php echo $blog['title']; ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="author">作者</label>
                                                <input type="text" class="form-control" id="author" name="author" placeholder="<?php echo $blog['author']; ?>">
                                            </div>
