<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"F:\wamp64\www\TP5.0_35\TP5.0\public/../application/admin\view\blogc\index.html";i:1502709103;}*/ ?>
﻿<!DOCTYPE html>
<!--
    ...
    <div class="page-container">
        ...
        <div class="page-content">
            ...
            <div class="page-body">
                ...
                <div class="row">
                    <div class="col-lg-10 col-md-18 col-sm-18 col-xs-18">
                        <div class="widget">
                            ...
                            <div class="widget-body">
                                <table class="table table-striped table-bordered table-hover" id="expandabledatatable">
                                    ...
                                    <tr>
                                        <td class="col-lg-2">
                                            <img src="<?php echo $blog['blogimg']; ?>" alt="">
