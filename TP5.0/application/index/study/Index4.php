...
class Index4 extends Controller
{
    ...
    {     
        ...
        echo $request->url(); //没有继承就用该方法 获取当前URL地址 不含域名
        echo "<br/>";
        echo $this->request->url(); // 继承控制器就是用该方法 获取当前URL地址 不含域名
        echo "<br/>";
        echo $this->request->bind('user_name','张三233333'); //  动态绑定属性
        echo "<br/>";
        ...
        echo "<br/>";
        /****param方法支持变量的过滤和默认值***/
        echo $request->param('en_name','jake','strtolower'); //strtolower转换成小写的方法名
        echo "<br/>";
    ...
    {     
        ...
        // $this->redirect('http://localhost/test2');
